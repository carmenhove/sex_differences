...
pacman::p_load(devtools, tidyverse, openxlsx, ggpubr,scales,
...
knitr::kable(table_s3 %>% 
               ...
               select(Population, Measure, `Reproductive Phase`, Age, NumPartos, Bias, `Female Value`, `Male Value`,pct_diff) %>% 
